    ...
    return activeUser /*&& activeUser.privilege === "admin" */? (
      <div className="articles-container">
        ...
        <ul className="users-rules">
          <li>"user" sadece mesaj yazabilir ve kendi mesajını silebilir.</li>
          <li>
            "powerUser" hem yazı, hem de mesaj ekleyebilir. Kendi yazısını
            düzenleyebilir, silebilir. Kendi mesajını silebilir.
          </li>
          <li>
